...
const text = {
  es: {
    ...
    item5Text: 'HVAC, protección contra incendios certificada FM Global, plomería industrial, ductos especializados, cuartos limpios y sistemas de temperatura controlada.',

      ...
      <div className="p-6 text-muted-foreground text-base space-y-10">
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="text-sm font-medium text-foreground mt-1 uppercase tracking-wider">Proyectos Entregados</div>
            <div className="h-0.5 w-10 bg-primary/20 mt-3" />
          </div>

          <div>
            <div className="text-3xl font-bold text-primary">+{totalM2.toLocaleString('es-MX')} m²</div>
            <div className="text-sm font-medium text-foreground mt-1 uppercase tracking-wider">Superficie Total</div>
            <div className="h-0.5 w-10 bg-primary/20 mt-3" />
          </div>

          <div>
            <div className="text-3xl font-bold text-primary">28</div>
            <div className="text-sm font-medium text-foreground mt-1 uppercase tracking-wider">Años de Trayectoria</div>
            <div className="h-0.5 w-10 bg-primary/20 mt-3" />
          </div>
        </div>
        ...
        <div className="pt-6 border-t border-border">
          <h4 className="font-semibold text-foreground text-sm uppercase tracking-widest mb-4">Alcance Geográfico</h4>

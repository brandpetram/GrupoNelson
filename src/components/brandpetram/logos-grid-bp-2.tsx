/**
 * Componente: LogosGridBP2
 * Brandpetramizado: 21 de marzo de 2026
 * Proyecto: Grupo Nelson — Cuadrícula de logos de clientes (variante 2)
 *
 * Layout: 40% texto izquierda, 60% cuadrícula de logos derecha
 * Grid: fila superior de 2 logos grandes + 4 columnas x 3 filas con líneas finas
 */
...
export function LogosGridBP2({
  ...
  return (
    <section data-component="LogosGridBP2" data-component-file="src/components/brandpetram/logos-grid-bp-2.tsx" data-component-props="true"
      ...
      className="w-11/12 mx-auto py-[3rem] 768:py-[4rem] 1024:py-[5rem] 1200:py-[5.5rem] 1920:py-[6rem]"
    >

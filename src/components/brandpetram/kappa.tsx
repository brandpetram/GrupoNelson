export function Kappa({ lang = 'es' }: { lang?: 'en' | 'es' }) {
  const text = {
    ...
    desc: lang === 'en'
      ...
      : 'Si tu operación requiere alturas específicas, capacidad eléctrica de alta demanda, cuartos limpios o sistemas especializados que no existen en el inventario, la Constructora de Casa de Grupo Nelson diseña y construye la nave según tus especificaciones exactas. Un solo proveedor para ambos caminos.',
    sidebar: lang === 'en'

export function Kappa({ lang = 'es' }: { lang?: 'en' | 'es' }) {
  const text = {
    ...
    desc: lang === 'en'
      ? "If your operation requires specific heights, high-demand electrical capacity, cleanrooms, or specialized systems that don't exist in inventory, Grupo Nelson's In-House Construction team designs and builds the facility to your exact specifications. One provider for both paths."
      : 'Si tu operación requiere alturas específicas, capacidad eléctrica de alta demanda, cuartos limpios o sistemas especializados que no existen en el inventario, la constructora de Grupo Nelson diseña y construye la nave según tus especificaciones exactas. Un solo proveedor para ambos caminos.',
    sidebar: lang === 'en'
    ...
    <section data-component="Kappa" data-component-file="src/components/brandpetram/kappa.tsx" data-component-props="false" className="mx-auto items-center py-16">
      ...
      <div className="w-full 360:w-[100%] 393:w-[95%] 430:w-[90%] 768:w-[85%] 834:w-[80%] 1024:w-[78%] 1200:w-[75%] mx-auto">
        <div className="w-full aspect-video overflow-hidden">
          <img src="/Seleccionadas/parque-industrial-nelson-2-en-mexicali.jpeg" alt="Entrada del Parque Industrial Nelson II en Mexicali" className="w-full h-full object-cover" />
        </div>
      </div>
    </section>
  )

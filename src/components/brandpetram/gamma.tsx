      ...
      <div>
          ...
          <div className="flex justify-center">
              ...
              <div
                  ...
                  {/* Div SDI centrado horizontalmente en el top, por detrás */}
                  <div
                      className="absolute -translate-y-15 right-10 1200:left-1/2 1200:-translate-x-1/2 w-50 h-60 bg-gradient-to-tr from-orange-500 to-red-600 rounded-t-sm flex items-center justify-center -z-10">
                  </div>

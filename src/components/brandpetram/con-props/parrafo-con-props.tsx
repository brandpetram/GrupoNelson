...
interface ParrafoConPropsProps {
  /** Texto del párrafo */
 ...
 *
 * ⭐ COPY SPEC:
 * - children: 100-180 chars (depende del contexto)
 *
 * Uso:
 * <ParrafoConProps fontSize="text-lg" lineHeight="leading-relaxed">
 *   Mi texto aquí...
 * </ParrafoConProps>
 */
export function ParrafoConProps({
  children,
  as: Component = 'p',
  fontSize = 'text-base',

...
export function GridPoligonos2x1x2() {
  return (
    <div data-component="GridPoligonos2x1x2" data-component-file="src/components/brandpetram/grid-poligonos-2x1x2.tsx" data-component-props="false" className="container mx-auto">
        ...
        <div className="md:col-span-2 grid grid-cols-2 gap-2.5 order-2 md:order-3">
          ...
          <div className="relative aspect-square">
            <div className="group relative flex items-center justify-center w-full h-full overflow-hidden bg-gradient-to-tr from-blue-600 to-blue-700 rounded-none">

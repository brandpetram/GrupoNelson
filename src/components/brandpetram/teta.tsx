export function Teta() {
  return (
      <div className={'overflow-hidden -mt-50 pt-81'}>
        <div
          ...
          <div
            ...
            <div className="relative translate-y-[4rem] 360:translate-y-[4rem]  393:translate-y-[4rem] z-30 md:z-0">
              ...
              <img
                  ...
                  className="w-[13rem] md:w-full ml-10 360:ml-18 393:ml-22 430:ml-28 md:ml-0 360:aspect-square 393:aspect-square 430:aspect-square 768:aspect-[2/3] 834:aspect-[2/3] 1024:aspect-[2/3] 1200:aspect-square 1280:aspect-[3/2] object-cover relative z-10 border-gray-300 border-2"
              />
            </div>
          </div>
          ...
          <div
            ...
            <img
                src="/placeholder.svg"
                alt="Imagen derecha"
                className="w-full aspect-square object-cover 360:translate-y-0 393:-translate-[0rem] 430:-translate-[0rem] 768:-translate-[4rem] 834:-translate-[6rem] 1024:-translate-[8rem] 1200:-translate-[9rem] 1280:-translate-[10rem] border-2 border-gray-300"
            />

...
export function GridPoligonos2() {
  return (
    <div data-component="GridPoligonos2" data-component-file="src/components/brandpetram/grid-poligonos-2.tsx" data-component-props="false" className="container mx-auto">

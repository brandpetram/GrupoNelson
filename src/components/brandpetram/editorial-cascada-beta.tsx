...
export function EditorialCascadaBeta({
  ...
  const defaults = lang === 'en' ? {
    ...
    titulo: 'La Diferencia Nelson: pioneros de la manufactura fronteriza desde 1956, operación directa por la familia fundadora y constructora propia.',
    parrafo: 'Grupo Nelson instaló la primera maquiladora de Mexicali en 1956. Tres generaciones después, la familia fundadora sigue operando cada parque, cada contrato y cada proyecto de construcción. Muy pocos desarrolladores industriales en esta ciudad combinan 60 años de permanencia, dueños involucrados operativamente y constructora propia con 30 años de experiencia. Eso se traduce en menos riesgo, menos fricción y más velocidad para tu proyecto.',
    stats: [

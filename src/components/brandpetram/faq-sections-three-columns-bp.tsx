...
const faqs = [
    ...
    {
        id: 5,
        question: '¿Incididunt ut labore et dolore magna aliqua ut enim?',
        answer:
    ...
    {
        id: 6,
        question: '¿Ad minim veniam quis nostrud exercitation ullamco laboris nisi ut?',
        answer:
        ...
        <div className="bg-foreground/5 bg-muted/20 relative">
            <div className="mx-auto w-full 360:w-full 393:w-11/12 430:w-11/12 768:w-10/12 834:w-10/12 1024:w-9/12 1200:w-8/12 1280:max-w-7xl 1366:max-w-7xl 1440:max-w-7xl 1536:max-w-7xl 1728:max-w-7xl 1920:max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
                <div className="mx-auto w-full 360:w-full 393:w-full 430:w-full 768:max-w-2xl 834:max-w-2xl 1024:max-w-2xl 1200:max-w-2xl 1280:max-w-2xl 1366:max-w-2xl 1440:max-w-2xl 1536:max-w-2xl 1728:max-w-2xl 1920:max-w-2xl text-center">
                    ...
                    <p className="mt-6 text-xs 360:text-xs 393:text-sm 430:text-sm 768:text-base 834:text-base 1024:text-lg 1200:text-lg 1280:text-xl 1366:text-xl 1440:text-2xl 1536:text-2xl 1728:text-2xl 1920:text-2xl text-muted-foreground">
                        ¿Tienes alguna pregunta que no encuentras aquí? Contáctanos por{' '}
                ...
                <div className="mt-20">
                    <dl className="space-y-16 sm:grid sm:grid-cols-2 sm:space-y-0 sm:gap-x-6 sm:gap-y-16 lg:grid-cols-3 lg:gap-x-10">
                        {faqs.map((faq) => (
                            <div key={faq.id}>
                                <dt className="text-base 360:text-base 393:text-base 430:text-lg 768:text-lg 834:text-xl 1024:text-xl 1200:text-2xl 1280:text-2xl 1366:text-3xl 1440:text-3xl 1536:text-4xl 1728:text-4xl 1920:text-4xl leading-none tracking-tighter font-semibold text-foreground">
                                    {faq.question}
                                </dt>
                                <dd className="mt-2 text-xs 360:text-xs 393:text-xs 430:text-sm 768:text-sm 834:text-base 1024:text-base 1200:text-base 1280:text-lg 1366:text-lg 1440:text-xl 1536:text-xl 1728:text-xl 1920:text-xl text-muted-foreground">
                                    {faq.answer}
                                </dd>
                            </div>
                        ))}

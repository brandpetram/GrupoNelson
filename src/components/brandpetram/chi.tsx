// Origen: daasyl2022V2/Cta
// Adaptaciones: eliminado next-i18next. Textos lorem ipsum.

const text = {
  es: {
    heading: '404 días sin accidentes. 1,092,745 horas hombre. Cero accidentes.',
    description: 'Si tu operación necesita una constructora con estándares internacionales en el noroeste de México, hablemos.',
    cta: 'Contáctanos',
    contactHref: '/contacto',
  },
  en: {
    heading: '404 days without accidents. 1,092,745 man-hours. Zero incidents.',
    description: "If your operation needs a construction firm with international standards in northwestern Mexico, let\u2019s talk.",
    cta: 'Contact Us',
    contactHref: '/contact',
  },
}

export default function Chi({ lang = 'es' }: { lang?: 'en' | 'es' }) {
  const t = text[lang]

    ...
    <article className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          {formatArea(generalData?.totalConstructionArea?.m2 ?? 0, generalData?.totalConstructionArea?.sqft)}
        </p>
      </div>

      {/* Datos Generales */}
      <SpecSection title="Datos Generales">
        <SpecRow label="Área de terreno" value={formatArea(generalData?.landArea?.m2 ?? 0, generalData?.landArea?.sqft)} />
        <SpecRow label="Construcción total" value={formatArea(generalData?.totalConstructionArea?.m2 ?? 0, generalData?.totalConstructionArea?.sqft)} />

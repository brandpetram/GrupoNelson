...
const text = {
  es: {
    ...
    subtitle: <>Informes <br className="md:hidden" />semanales</>,
    ...
    doc3: 'Control de entregables técnicos e insumos de entrega prolongada',
    ...
    svc2Href: '/contacto',
    svc2Btn: 'Ver más',
    svc3Title: 'Adecuaciones del cliente',

  ...
  return (
    <div className="relative z-10 mt-[20rem]">
      ...
      <div className="relative z-10 lg:ml-20 3xl:ml-40 lg:pt-16 lg:max-w-3xl 3xl:max-w-4xl pb-16">
        <h1 className="text-foreground w-10/12 md:w-full mx-5 lg:mx-0 text-4xl lg:text-5xl 2xl:text-6xl leading-tight font-bold leading-none">
        ...
        <div className="py-16 px-0 sm:px-6 lg:py-16 lg:px-0 lg:grid lg:grid-cols-5 lg:gap-x-9">
          ...
          <div className="col-span-2 mx-5 lg:mx-0 text-foreground">
            <h2 className="-mt-10 text-sm font-semibold text-muted-foreground uppercase tracking-wide">
              Grupo Nelson <br className="md:hidden" />
              consectetur adipiscing
            </h2>
            <p className="w-10/12 md:w-2/3 lg:w-full mt-5 text-base leading-7 font-semibold">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod.
            </p>
            <p className="w-full md:w-2/3 lg:w-full mt-7 text-sm leading-7 text-muted-foreground">
              Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
              aliquip ex ea commodo consequat.
            </p>
            <h4 className="mt-10 font-bold text-base">Lorem ipsum:</h4>
          ...
          <div className="mt-12 lg:mt-0 lg:col-span-3 lg:ml-8 mx-10 lg:mx-0">
            <dl className="space-y-0">
              ...
              <div className="space-y-2 pb-6">
                ...
                <dd className="flex">
                  <span className="flex-1 mr-6 text-sm leading-6 text-muted-foreground">

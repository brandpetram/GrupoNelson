...
const text = {
  ...
  en: {
    ...
    faqs: [
      ...
      { id: 5, question: 'Which companies have you built for?', answer: 'Gulfstream (40+ year relationship), Honeywell (30 years), DHL, Vertiv, Skyworks, Intuitive Surgical, Rheem, Baxter, Deacero, Direct Pack, among others. The full list includes 33 international corporations, several Fortune 500. 80% of our clients return project after project.' },

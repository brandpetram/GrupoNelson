...
const text = {
  es: {
    ...
    faqs: [
      { id: 1, question: '¿Qué diferencia a Constructora de Casa de otras constructoras en Mexicali?', answer: 'La Constructora de Casa de Grupo Nelson concentra diseño, estimación, construcción y supervisión bajo un mismo contrato. El arquitecto que traza la distribución trabaja en el mismo edificio que el superintendente que supervisa el colado. No subcontratamos diseño — contamos con 6 departamentos propios de ingeniería.' },
      { id: 2, question: '¿Qué tamaño de nave industrial pueden construir?', answer: 'Desde naves de 5,000 m² hasta complejos aeroespaciales de más de 50,000 m². El proyecto más grande activo es Gulfstream 550K con 52,200 m² bajo techo más 13,500 m² de oficinas. En 30 años hemos completado 75 proyectos que suman 4.5 millones de pies cuadrados para 33 corporaciones internacionales.' },
      { id: 3, question: '¿Qué certificaciones tiene nuestra Constructora de Casa?', answer: "Certificación ISN (ISNetworld). Certificación FM Global en muros, cubierta, estructura y sistema contraincendio. LEED Gold en proceso para el proyecto Gulfstream 550K. Diseño conforme a NFPA, IBC y Normas Oficiales Mexicanas. Todo el personal con certificación DC-3." },
      { id: 4, question: '¿Cómo gestionan la seguridad en obra?', answer: 'Manual SSMA de 18 capítulos. Permisos de trabajo diarios con matriz de riesgo cuantitativa antes de cada turno. Control de presión arterial para trabajo en alturas conforme a NOM-009-STPS-2011. Vigía Vigilante de Incendios en zonas de soldadura conforme a NOM-027-STPS-2008. La tabla de indicadores del proyecto Gulfstream registra 404 días consecutivos sin accidentes y 1,092,745 horas hombre con cero fatalidades.' },
      { id: 5, question: '¿Para qué empresas han construido?', answer: 'Gulfstream (40+ años de relación), Honeywell (40 años), DHL, Vertiv, Skyworks, Intuitive Surgical, Rheem, Baxter, Deacero, Direct Pack, entre otras. La lista completa incluye 33 corporaciones internacionales, varias Fortune 500. El 80% de nuestros clientes regresan proyecto tras proyecto.' },
      { id: 6, question: '¿Qué tipo de construcción realizan?', answer: 'A la medida (nave nueva diseñada a la medida de tu operación), expansión de naves existentes sin detener producción, y adecuaciones del cliente (adecuación de nave existente a tus requerimientos). Las 10 disciplinas constructivas se ejecutan con equipo propio: terracerías, cimentación, mampostería, estructura, techumbre, fachadas, interiores, acabados, eléctrica y mecánica.' },
      ...
      { id: 9, question: '¿Pueden construir proyectos especiales fuera de naves estándar?', answer: 'Sí. Hemos diseñado y construido un puente vehicular de 95 metros sin columnas para Skyworks (semiconductores), un túnel de viento con soplador de 3,000 HP para Honeywell (aeroespacial), y cimentaciones de precisión milimétrica a 15 metros de profundidad para Deacero (manufactura pesada). Proyectos que no se licitan en un directorio — se asignan por trayectoria.' },
    ],
  },
  en: {
    ...
    faqs: [
      { id: 1, question: 'What sets our In-House Construction team apart from other construction firms in Mexicali?', answer: "Grupo Nelson's In-House Construction team integrates design, estimation, construction, and supervision under a single contract. The architect who draws the layout works in the same building as the superintendent who oversees the concrete pour. We do not outsource design \u2014 we have 6 in-house engineering departments." },
      { id: 2, question: 'What size industrial buildings can you construct?', answer: 'From buildings of 54,000 ft\u00B2 to aerospace complexes exceeding 540,000 ft\u00B2. The largest active project is Gulfstream 550K with 562,000 ft\u00B2 under roof plus 145,000 ft\u00B2 of offices. Over 30 years we have completed 75 projects totaling 4.5 million square feet for 33 international corporations.' },
      { id: 3, question: 'What certifications does our In-House Construction team hold?', answer: "ISN (ISNetworld) certification. FM Global certification for walls, roofing, structure, and fire protection systems. LEED Gold in progress for the Gulfstream 550K project. Design compliant with NFPA, IBC, and Mexican Official Standards. All personnel hold DC-3 certification." },
      ...
      { id: 5, question: 'Which companies have you built for?', answer: 'Gulfstream (40+ year relationship), Honeywell (40 years), DHL, Vertiv, Skyworks, Intuitive Surgical, Rheem, Baxter, Deacero, Direct Pack, among others. The full list includes 33 international corporations, several Fortune 500. 80% of our clients return project after project.' },

/**
 * Componente original: pro-blocks/feature-section-5-inverted
...
import { Tagline } from "../pro-blocks/feature-section-5/tagline";
import { CuadritosLluviaTres } from "../ui/brandpetram/cuadritos-lluvia-tres";

export function FeatureSection5InvertedBP() {
  return (
    <section data-component="FeatureSection5InvertedBP" data-component-file="src/components/brandpetram/feature-section-5-inverted-bp.tsx" data-component-props="false" className="bg-background section-padding-y">

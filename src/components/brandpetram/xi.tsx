...
const text = {
  es: {
    ...
    label: 'Trayectoria',
    heading: '33 corporaciones internacionales en 30 años',
    p1: 'Experiencia constructiva con estándares Fortune 500. Unificamos toda la cadena de diseño, decisión y obra en una sola firma para asegurar el éxito de tu proyecto de principio a fin.',
    ...
    li3: 'Mexicali, Hermosillo, Tecate, San Luis Río Colorado, San Luis Potosí, Tijuana, Guadalajara',
    subheading: 'El historial habla por sí solo',
    closing: 'Si requieres desarrollar una nave industrial con estándares internacionales en el noroeste de México, será un gusto atenderte.',
    cta: 'Contáctanos',
  ...
  en: {
    ...
    label: 'Track Record',
    heading: '33 International Corporations in 30 Years',
    p1: 'Construction experience built to Fortune 500 standards. We unify the entire chain of design, decision-making, and construction within a single firm to ensure the success of your project from start to finish.',
    ...
    li3: 'Mexicali, Hermosillo, Tecate, San Luis Rio Colorado, San Luis Potosi, Tijuana, Guadalajara',
    subheading: 'The track record speaks for itself',
    closing: "If you\u2019re looking to develop an industrial building with international standards in northwestern Mexico, we\u2019d be glad to help.",
    cta: 'Contact Us',
    contactHref: '/contact',
  },
}

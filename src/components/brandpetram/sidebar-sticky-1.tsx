...
const sidebarText = {
  es: {
    ...
    datos: [
      ...
      '30 años en clima extremo',
      '75+ proyectos en Mexicali',
    ],
    constructora: 'Constructora',
    constructoraLinks: [
      { href: '/constructora/baumex', label: 'Constructora de Casa' },
    ...
    p2_2: 'Nuestra Constructora de Casa tiene 30 años de datos de desempeño térmico en naves construidas en Mexicali — 75+ proyectos en la misma zona climática. No son modelos teóricos: son datos reales de operación en el desierto sonorense. La nave Gulfstream 550K opera hoy con envolvente calibrada para las condiciones reales del sitio — 48°C de temperatura exterior y 2,400 kWh/m² de radiación solar anual.',
    h2_3: 'Un solo equipo que diseña, construye y gestiona la certificación',
    p3_1: 'Nuestra Constructora de Casa gestiona el proceso integrativo LEED v4 BD+C desde la fase preliminar de diseño: registro, revisión de diseño, gestión de evidencias en construcción y revisión de construcción con trazabilidad completa. No es un consultor externo que solo prepara documentos — es la misma constructora que diseña y ejecuta la obra.',
    p3_2: 'Si tu corporativo exige o está evaluando LEED para tu próxima instalación en Mexicali, habla con un equipo que lleva 30 años construyendo en esta zona climática. Cada pilar LEED tiene su propia página con datos técnicos reales — explora los detalles en las secciones de abajo.',
  },
  en: {
    ...
    datos: [
      ...
      '30 years in extreme climate',
      '75+ projects in Mexicali',
    ],
    constructora: 'Construction',
    constructoraLinks: [
      { href: '/construction/baumex', label: 'In-House Construction' },
    ...
    p2_2: 'Our In-House Construction team has 30 years of thermal performance data from buildings constructed in Mexicali — 75+ projects in the same climate zone. These are not theoretical models: they are real operating data from the Sonoran Desert. The Gulfstream 550K facility operates today with an envelope calibrated for actual site conditions — 48°C exterior temperature and 2,400 kWh/m² of annual solar radiation.',
    h2_3: 'One team that designs, builds, and manages the certification',
    p3_1: 'Our In-House Construction team manages the LEED v4 BD+C integrative process from predesign: registration, Design Review, construction evidence management, and Construction Review with full traceability. It is not an external consultant that only prepares documents — it is the same construction firm that designs and executes the project.',
    p3_2: 'If your corporation requires or is evaluating LEED for your next facility in Mexicali, talk to a team with 30 years of building experience in this climate zone. Each LEED pillar has its own page with real technical data — explore the details in the sections below.',
  },
}

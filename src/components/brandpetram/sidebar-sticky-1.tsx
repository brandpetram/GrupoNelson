...
const sidebarText = {
  es: {
    ...
    constructoraLinks: [
      { href: '/constructora/baumex', label: 'Nuestra Constructora' },
    ...
    p1_2: 'Gulfstream — Fortune 500, aeroespacial — ya está certificando LEED Gold su nave de 52,200 m² en Mexicali. No es un plan futuro. Es un proyecto en proceso, ejecutado por nuestra constructora. Para el CFO o el VP de Real Estate que necesita justificar la inversión: una nave LEED no solo cumple requisitos corporativos — tiende a reducir costos operativos de energía y agua, y posiciona el activo en un mercado que cada vez valora más la sustentabilidad.',
    h2_2: 'La ventaja competitiva de clima extremo: por qué elegir nuestra constructora en Mexicali',

...
const editorialCascadaDefaults = {
  es: {
    titulo: 'De la primera maquiladora de Mexicali a albergar algunos de los proyectos industriales más complejos de la ciudad.',
    parrafo: 'En 1956, don Rodolfo Nelson Barbara instaló la primera maquiladora de Mexicali. No existían parques industriales — existía una visión. Tres generaciones después, esa visión se convirtió en cinco parques industriales, cuatro millones de pies cuadrados rentados y la confianza de treinta corporaciones internacionales que eligieron Mexicali porque Grupo Nelson ya había construido la infraestructura que necesitaban.',

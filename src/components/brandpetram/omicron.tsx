...
export default function Omicron() {
  return (
    <div className="pb-10 mt-32 w-10/12 mx-auto text-sm 360:text-sm 393:text-[0.9rem] 430:text-[0.95rem] 768:text-base 834:text-base 1024:text-lg 1200:text-[0.95rem] 1280:text-[1rem] 1366:text-[1.05rem] 1440:text-[1.1rem] 1536:text-[1.15rem] 1728:text-[1.3rem] 1920:text-[1.5rem] text-muted-foreground overflow-hidden">
      {/* Fila 1 */}
      <div className="grid grid-cols-12 gap-5 lg:gap-20">
        ...
        <div className="col-span-7 lg:col-span-8 my-auto md:leading-relaxed">
          <h1 className="text-foreground mb-5 font-bold text-3xl 360:text-[2rem] 393:text-[2.2rem] 430:text-[2.5rem] 768:text-5xl 834:text-[3.5rem] 1024:text-6xl 1200:text-[2.8rem] 1280:text-[3.2rem] 1366:text-[3.5rem] 1440:text-[3.8rem] 1536:text-[4.2rem] 1728:text-[5rem] 1920:text-[6rem] leading-none">
            Lorem ipsum
          </h1>
          <p>
      ...
      <div className="grid grid-cols-12 gap-5 lg:gap-20 md:-my-10">

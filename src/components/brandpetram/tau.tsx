    ...
    <div className="md:my-20 md:w-11/12 mx-auto overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="lg:w-1/2 grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="aspect-square bg-linear-to-br from-blue-500 to-blue-700 relative overflow-hidden">
            ...
            <div className="absolute left-0 top-0 w-[15%] h-full flex items-start justify-start pt-[19%] -translate-x-1">
              <svg className="w-10 h-auto" viewBox="0 0 78 163">
            ...
            <div className="absolute right-0 top-[7.5%] w-[85%] aspect-square bg-white transition duration-300 ease-in-out hover:-translate-y-1 hover:scale-90 overflow-hidden">
          ...
          <div className="aspect-square relative bg-linear-to-br from-blue-500 to-blue-700 text-white">
            <div className="absolute inset-0 flex flex-col items-center justify-center cursor-pointer">

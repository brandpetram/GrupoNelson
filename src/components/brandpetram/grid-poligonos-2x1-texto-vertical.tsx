...
export function GridPoligonos2x1TextoVertical() {
  return (
    <div data-component="GridPoligonos2x1TextoVertical" data-component-file="src/components/brandpetram/grid-poligonos-2x1-texto-vertical.tsx" data-component-props="false" className="container mx-auto">

...
export default function Example() {
    return (
        <div data-component="Example" data-component-file="src/components/tailwind-ui/content-sections/with-sticky-product-screenshot.tsx" data-component-props="false" className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">

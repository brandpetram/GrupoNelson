    ...
    return (
        <section className="bg-background">
            <div className="bg-foreground/9 @container relative">
                ...
                <div className="z-1 relative grid grid-cols-[1fr_auto_1fr]">
                    <Decorator />
                                        ...
                                        <div
                                            ...
                                            {filters.map((category, index) => (
                                                <button
                                                    ...
                                                    <span className={cn('flex w-fit items-center gap-2 rounded-md px-3 py-1 text-sm transition-colors [&>svg]:size-4', activeFilter === category ? 'bg-illustration ring-border-illustration text-primary font-medium shadow-sm ring-1' : 'hover:text-foreground group-hover:bg-foreground/5')}>
                                ...
                                <div className="grid gap-px sm:grid-cols-2">
                                    {articles.map((article, index) => (
                                        <article
                                            ...
                                            <div className="before:inset-ring-1 before:inset-ring-foreground/10 before:border-background/10 relative aspect-video overflow-hidden rounded-[10px] shadow-md shadow-black/10 before:absolute before:inset-0 before:rounded-[10px] before:border">
                                                <Image
                                                    src={article.image}
                                                    alt={article.title}
                                                    width={6394}
                ...
                <div
                    aria-hidden
                    className="bg-linear-to-r/increasing pointer-events-none fixed absolute inset-0 left-0 top-0 z-0 size-56 -translate-x-1/2 -translate-y-1/2 rounded-full from-indigo-300 via-white to-emerald-300 opacity-25 blur-2xl will-change-transform"

    ...
    return (
        <div
            ...
            <div className={cn('max-w-276 xl:min-w-276 mx-auto w-full', !asGrid && 'p-[0.5px]')}>
                {asGrid ? (
                    <div className={cn('**:data-grid-content:bg-card/75 **:data-grid-content:h-full **:data-grid-content:rounded grid *:p-[0.5px]', className)}>{children}</div>
                ) : (
                    <div
                        data-slot="content"
                        className={cn('bg-card/75 h-full rounded', className)}>
                        {children}
                    </div>
                )}
            </div>
...
const Decorator = ({ className }: { className?: string }) => {
    return (
        <div
            ...
            <div className="bg-card/75 h-full w-2 rounded lg:w-12 xl:w-full" />
        </div>
    )
}
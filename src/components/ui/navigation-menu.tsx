...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{' '}
      <ChevronDownIcon
        className="relative top-0 ml-1.5 size-3 opacity-75 transition duration-300 group-data-[state=open]:translate-y-px"
        aria-hidden="true"
        strokeWidth={2.5}
      />
    </NavigationMenuPrimitive.Trigger>
...
function NavigationMenuContent({
  ...
  delete (forwardedProps as Record<string, unknown>).onCloseAutoFocus;

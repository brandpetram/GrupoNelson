...
export default function PortafolioBaumexClient() {
  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 mt-20 lg:mt-32">
        {/* Hero Section */}
        <div className="max-w-3xl">
          <h1 className="text-6xl sm:text-7xl font-extrabold tracking-tighter leading-none text-gray-900 dark:text-white">
            75 proyectos. 28 años.
            <span className="block text-primary mt-2">Un estándar que no se negocia.</span>
          </h1>

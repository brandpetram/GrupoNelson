...
export const metadata = createMetadata({
  ...
  description: '5 parques industriales en Mexicali con más de 4.5 millones de pies². Naves industriales de construcción a la medida (build-to-suit), terrenos disponibles y más de 60 años de experiencia.',
})

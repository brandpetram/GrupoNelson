                ...
                <div className="@3xl:p-20 @lg:p-8 relative overflow-hidden p-6">
                    <div className="mx-auto max-w-xl text-center">
                        <div className="relative">
                            ...
                            <p className="text-foreground mb-6 mt-4 text-balance text-lg">Planeación documentada, reportes semanales, minutas firmadas y tabla de indicadores de seguridad. 75 proyectos gestionados con este método en 30 años.</p>

...
export const metadata = createMetadata({
  ...
  description: 'Las empresas más exigentes que operan en Mexicali ya eligieron a Grupo Nelson. Gulfstream 40 años, Honeywell 40+. Relaciones de largo plazo que se miden en décadas.',
})

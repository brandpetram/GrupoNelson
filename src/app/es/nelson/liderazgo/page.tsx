...
export const metadata = createMetadata({
  ...
  title: 'Liderazgo',
  description: 'Tres generaciones liderando el desarrollo de parques industriales y naves industriales de construcción a la medida (build-to-suit) en Mexicali. La familia fundadora opera directamente cada proyecto.',
})
...
const team = [
  ...
  },
  {
    ...
    role: 'Nuestra Constructora — construcción a la medida',
    description:
      'Nuestra constructora ejecuta cada proyecto de principio a fin. Las decisiones de ingeniería y presupuesto se validan en consejo ejecutivo — tu obra no depende de un solo gerente de proyecto.',
  },
  {
          ...
          <div className="px-6 md:px-12 lg:px-20 py-24 md:py-32">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-3xl">
              <p className="text-base leading-relaxed text-muted-foreground/80">
                La continuidad del liderazgo no se limita a la familia. Nuestra constructora

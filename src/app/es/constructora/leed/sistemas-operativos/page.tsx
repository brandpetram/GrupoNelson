...
export const metadata = createMetadata({
  ...
  description: 'BMS con submedición por circuito para naves industriales LEED en Mexicali. Monitoreo en tiempo real de climatización, energía solar y agua. Tableros de control ESG. Grupo Nelson.',
})
...
export default function SistemasOperativosPage() {
  return (
    <LeedPageLayout
      ...
      intro="Gulfstream 550K opera con 42 manejadoras de A/C, 10 MW de paneles solares y 20 MW de capacidad eléctrica. Sin monitoreo inteligente por circuito, detectar una desviación de consumo toma meses. Con BMS y submedición, toma horas. La constructora interna de Grupo Nelson integra estos sistemas desde la construcción de la nave — no como modernización."
      ...
      parrafos={[
        'Identifica desviaciones de consumo energético en horas, no en meses. Nuestro equipo de construcción integra Building Management Systems con submedición independiente por circuito: climatización, iluminación, bombas, sistema fotovoltaico y consumo hídrico monitoreados desde una sola plataforma. En Mexicali, donde la climatización puede representar más del 40% del gasto operativo de una nave, esa visibilidad es la diferencia entre operar con datos y operar con intuición.',
        'Simplifica tus reportes ESG con trazabilidad energética e hídrica automática. Los tableros de control de consumo por sistema y las alertas de desviación alimentan reportes corporativos sin esfuerzo manual adicional. Para empresas Fortune 500 que operan en parques de Grupo Nelson — Gulfstream, Honeywell, DHL — este nivel de trazabilidad no es opcional: es lo que sus corporativos exigen para reportar a inversionistas y consejos directivos.',
      ...
      features={[
        {
          ...
          description: 'Climatización, iluminación, bombas, fotovoltaicos y consumo hídrico monitoreados en tiempo real desde una sola plataforma.',
        },
        {
        ...
        {
          title: 'Tableros de control ESG sin esfuerzo manual',

...
export default function SistemasOperativosPage() {
  return (
    <LeedPageLayout
      ...
      parrafoCierre="Opera tu nave industrial en Mexicali con la visibilidad que exige una operación multinacional. Baumex integra BMS y submedición desde la construcción para que cada sistema — climatización, solar, agua, iluminación — sea medible, auditable y optimizable. Solicita una consulta para tu proyecto."

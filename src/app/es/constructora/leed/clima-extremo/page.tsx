...
export const metadata = createMetadata({
  ...
  description: 'Construcción de naves industriales LEED en Mexicali con +45°C. Envolvente térmica R-19/R-30, cubiertas SRI >78, delta de 24°C controlado. 30 años de experiencia en clima extremo.',
})
  ...
  return (
    <LeedPageLayout
      ...
      parrafos={[
        ...
        'Gulfstream 550K (52,200 m²) opera en Mexicali con 3,200 toneladas de aire acondicionado de mínimo consumo distribuidas en 42 manejadoras, cubierta TPO con garantía de 20 años y recuperación del 90% del agua de condensación. Cada especificación de envolvente fue calibrada por nuestra constructora interna para las condiciones reales del sitio — 48°C de temperatura exterior y 2,400 kWh/m² de radiación solar anual.',
        'Accede a 30 años de datos de desempeño térmico en naves industriales de Mexicali. Un error de cálculo en la envolvente de una nave a 48°C dispara el consumo de climatización entre 30% y 50% sobre el diseño original (ASHRAE 90.1). Nuestro equipo calibra estas especificaciones con décadas de ejecución en la misma zona — 75+ naves con datos de operación reales.',
      ]}
      features={[
        {

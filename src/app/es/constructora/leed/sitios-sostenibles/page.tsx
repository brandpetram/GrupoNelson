  ...
  return (
    <LeedPageLayout
      ...
      parrafos={[
        ...
        'Aprovecha los más de 5,000 m² de cubierta de tu nave para captación pluvial. Aunque Mexicali recibe precipitación limitada, los eventos pluviales concentrados generan volúmenes recuperables. Combinados con accesorios sanitarios de ultra-bajo flujo, el consumo total de agua se reduce un 40% frente a una nave convencional. Nelson II cuenta con sistema contraincendio central con tanque de 360,000 galones — infraestructura que ya existe en el parque.',
        'Asegura eficiencia hídrica en tu nave industrial de Mexicali con la infraestructura que Grupo Nelson ya tiene instalada. El sistema contraincendio centralizado de Nelson II ahorra al inquilino el 60% del costo frente a sistemas individuales. La recuperación de agua de condensación de las manejadoras de climatización reutiliza el recurso dentro del mismo edificio. Cada galón documentado suma créditos en la categoría de eficiencia hídrica de LEED.',
      ]}
      features={[
        {
        ...
        },
        {
          ...
          description: 'Captación pluvial + accesorios ultra-bajo flujo + recuperación del 90% de agua de condensación de climatización.',
        },
      ]}
      subtituloSeccion="Certifica LEED eficiencia del agua en tu nave industrial de Mexicali con infraestructura ya instalada"

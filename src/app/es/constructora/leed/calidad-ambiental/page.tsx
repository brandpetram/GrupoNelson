...
export default function CalidadAmbientalPage() {
  return (
    <LeedPageLayout
      ...
      parrafos={[
        'Especifica materiales verificados contra umbrales LEED antes de que se instalen en tu nave. Pinturas y recubrimientos con compuestos orgánicos volátiles por debajo de 50 g/L, selladores por debajo de 250 g/L, adhesivos por debajo de 70 g/L, y sistemas de piso con certificación FloorScore. Nuestra constructora interna verifica cada producto que entra a obra contra estos umbrales — en Mexicali, donde las naves operan con recirculación intensiva de aire por temperaturas que superan los 45°C, controlar las fuentes de emisión interior protege directamente a las personas que trabajan dentro.',

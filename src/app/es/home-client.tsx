    ...
    <div>
      ...
      <div className={'w-full p-10 mx-auto mt-32 relative'}>
              <Mosaico2ConProps
                  ...
                  bloque1Descripcion="4 parques operando en Mexicali con naves listas para operar — nuestro 5to parque, Nelson III, en sus primeras etapas de desarrollo"
              ...
              <div className="-mt-1">
                  <MosaicoInvertidoConProps
                      ...
                      imagenIzquierdaAlt="Nave industrial a la medida construida por nuestra constructora en Mexicali"
                  />
              </div>
          </div>

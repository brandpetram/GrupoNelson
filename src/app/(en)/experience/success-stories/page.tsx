...
export const metadata = createMetadata({
  ...
  description: 'The most demanding companies operating in Mexicali already chose Grupo Nelson. Gulfstream 40 years, Honeywell 40+. Long-term relationships measured in decades.',
})

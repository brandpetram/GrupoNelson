...
export const metadata = createMetadata({
  ...
  description: 'LEED industrial building construction in Mexicali at +45°C. R-19/R-30 thermal envelope, SRI >78 roofing, 24°C delta controlled. 30 years of extreme climate experience.',
})
...
export default function ExtremeClimatePage() {
  return (
    <LeedPageLayout lang="en"
      ...
      titulo="Build your LEED industrial building in Mexicali at +45°C — 30 years of extreme climate engineering"
      intro="Mexicali exceeds 48°C in summer with solar radiation of 2,400 kWh/m² annually. Our In-House Construction team has built 75+ industrial buildings under these conditions over 30 years. The thermal envelope of each building is calibrated specifically for the Sonoran Desert using performance data collected in the same climate zone."
      ...
      parrafos={[
        ...
        'Gulfstream 550K (52,200 m²) operates in Mexicali with 3,200 tons of minimum-consumption air conditioning distributed across 42 air handling units, a TPO roof with a 20-year warranty, and 90% condensation water recovery. Every envelope specification was calibrated by our In-House Construction team for actual site conditions — 48°C exterior temperature and 2,400 kWh/m² annual solar radiation.',
        'Access 30 years of thermal performance data from industrial buildings in Mexicali. A miscalculation in the envelope of a building at 48°C drives HVAC costs 30% to 50% above the original design (ASHRAE 90.1). Our In-House Construction team calibrates these specifications with decades of execution in the same zone — 75+ buildings with real operational data.',
      ]}
      features={[
        {
      ...
      fuentes="ASHRAE 90.1 (Energy Standard for Buildings) · LEED v4.1 Energy & Atmosphere Credits · Project data: Gulfstream 550K, In-House Construction (2024-2026)"
    />
  )
}

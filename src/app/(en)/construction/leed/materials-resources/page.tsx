...
export default function MaterialsResourcesPage() {
  return (
    <LeedPageLayout lang="en"
      ...
      parrafos={[
        'Demand verifiable data for every material entering your Mexicali industrial building. Recycled steel significantly reduces CO₂ emissions compared to virgin steel (World Steel Association, 2023) — but it only counts if it has an EPD to prove it. Our In-House Construction team specifies structural steel with high documented recycled content, concrete with fly ash or slag that improves durability in extreme climate, and finishing materials with Health Product Declarations (HPD).',
        'Reduce the transportation footprint with regional sourcing within a 160-km radius of the Mexicali construction site. Steel from Ternium and ArcelorMittal, concrete from local CEMEX and Holcim plants, and construction materials from regional distributors — all within the radius that earns LEED credits in the Materials & Resources category. Grupo Nelson has long-term relationships with these suppliers — 30 years of construction in Mexicali builds a supply chain that cannot be improvised.',
        'Manage construction waste with 100% separation of recoverable materials and a minimum 50% diversion from landfill. Steel, concrete, cardboard, wood, and packaging plastics — each fraction with a documented destination and verifiable traceability. For the Gulfstream 550K building, our in-house team managed waste from 52,200 m² of construction to this standard.',
      ]}
      features={[
        {
        ...
        },
        {
          ...
          description: 'Local Mexicali suppliers that earn additional LEED credits. 30 years of relationships with the regional supply chain.',
        },
        {
      ...
      parrafoCierre="Build your Mexicali industrial building with materials that have EPDs, recycled content certificates, and documented waste traceability. Grupo Nelson integrates these standards into every project with suppliers like Ternium, CEMEX, and Holcim within the 160-km radius. Request a consultation."
      fuentes="LEED v4.1 Materials & Resources Credits · ISO 14025 (Environmental Product Declarations) · Project data: Gulfstream 550K, Grupo Nelson (2024-2026)"
    />
  )
}

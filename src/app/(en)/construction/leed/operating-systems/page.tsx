...
export default function OperatingSystemsPage() {
  return (
    <LeedPageLayout lang="en"
      ...
      intro="Gulfstream 550K operates with 42 A/C air handlers, 10 MW of solar panels, and 20 MW of electrical capacity. Without intelligent circuit-level monitoring, detecting a consumption deviation takes months. With BMS and submetering, it takes hours. Our In-House Construction team integrates these systems during building construction — not as a retrofit."
      ...
      parrafoCierre="Operate your Mexicali industrial building with the visibility that multinational operations demand. Our In-House Construction team integrates BMS and submetering from construction so that every system — HVAC, solar, water, lighting — is measurable, auditable, and optimizable. Request a consultation for your project."

...
export default function EnergyAtmospherePage() {
  return (
    <LeedPageLayout lang="en"
      ...
      intro="Gulfstream 550K in Mexicali: 10 MW of solar panels across 50,000 m² (rooftop + carports), 20 MW installed electrical capacity, 50% clean solar energy. 3,200 tons of minimum-consumption A/C. These are the real results of the LEED Energy & Atmosphere category executed by our In-House Construction team on the largest industrial building in the city."
      ...
      parrafoCierre="Maximize Energy & Atmosphere credits in your Mexicali industrial building. With a calibrated envelope, efficient lighting, and rooftop solar panels, our In-House Construction team has demonstrated 35-50% savings in the largest building in the city. Request a consultation for your project."
      fuentes="ASHRAE 90.1 (Energy Baseline) · LEED v4.1 Energy & Atmosphere Credits · Project data: Gulfstream 550K, In-House Construction (2024-2026)"
    />
  )
}

      ...
      <main>
        ...
        <div>
          <GunLikeConProps
            ...
            parrafo="Civil, structural, electrical, mechanical, architecture, and cost engineering. From foundations in seismic zones to 20 MW substations and FM Global fire protection."
          />
        </div>
        ...
        <div className="w-11/12 mx-auto 1200:-translate-y-16 1366:-translate-y-16 1728:-translate-y-24">
          <FeatureSection6BPConProps
            ...
            feature1Description="Soil mechanics, 18 m concrete piles in collapsible sandy soil, BRB seismic systems for seismic zones. Your foundation is calculated for your exact terrain."
        ...
        <div>
          <CuadroCirculoConEscuadraConProps
            titulo="Where conventional engineering stops, we begin."
            parrafo="We created the engineering Mexicali didn't have: unique seismic systems, column-free bridges over federal drainage channels, and wind tunnels with 3,000 HP of power. We've already designed and built it. Push the limits of engineering with solutions tailored to you."
            numeroCirculo="18"
            simboloNumero="m"
        ...
        <div className="w-11/12 mx-auto -mt-20 md:-mt-64 1024:-mt-40 relative">
          <Mosaico2ConProps
            bloque1Titulo="550k ft² for Gulfstream"
        ...
        <div className="flex flex-col gap-4">
          <div className="container ml-10 md:mx-auto 1200:-translate-x-16 w-7/12 md:w-8/12 1200:w-8/12 1366:w-8/12 1536:w-9/12 lg:max-w-6xl my-10 md:mt-20">
            <ParrafoBigConProps>
              Reinforced concrete piles driven 18 meters deep in collapsible sandy soil. BRB seismic systems for seismic zones. A 95-meter vehicular bridge with no columns. A wind tunnel rated for 3,000 HP of pressure. That is engineering.
            </ParrafoBigConProps>
          </div>
        </div>
        ...
        <div className="container mx-auto w-10/12">
          <FeatureSection5InvertedBPConProps
            ...
            feature1Descripcion="BRB (Buckling-Restrained Braces) systems for seismic zones. First implementation in Mexicali — technology from Japan and Mexico City."
            feature2Icon={<Zap className="h-5 w-5" />}
            feature2IconColor="text-blue-600"
        ...
        <div className="container mx-auto w-10/12 lg:mt-20">
          <FeatureSection3BPConProps
            ...
            descripcion="We guarantee regulatory compliance from the executive project. Designing with certifications in mind from day one eliminates rework, optimizes your investment, and ensures lower insurance premiums."
            ...
            feature1Descripcion="Your facility is designed to pass FM Global audits on walls, roof, structure, and fire protection system. Gulfstream 550K is LEED Gold certified with 10 MW solar."
            feature2Icon={<Zap className="h-5 w-5" />}
            feature2IconColor="text-blue-600"
        ...
        <div>
          <SplitWithImageBPConProps
            ...
            parrafo1="18-chapter HSE manual. Permits before every shift. Blood pressure checks before working at heights. DC-3 certification for all personnel. Maximum 12-hour shifts."
            parrafo2="If your corporate runs safety audits before authorizing a builder, we back you with our results:"
            ...
            feature1Titulo="+1M man-hours without fatalities."
            feature1Descripcion=""
            ...
            feature2Titulo="+400 days without accidents."
            feature2Descripcion=""
          ...
          <FaqSectionsThreeColumnsBPConProps
            ...
            faqs={[
              ...
              },
              {
                ...
                answer: "Yes. The executive project integrates solar panels, high-efficiency HVAC with 90% water recovery, and certified materials. Gulfstream 550K is LEED Gold certified with 10 MW solar.",
              },
              {
                id: 3,
                question: "How do I protect my facility in a seismic zone?",

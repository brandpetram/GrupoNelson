      ...
      <main className="bg-background text-foreground mt-32">
          ...
          <div className="container mx-auto w-10/12 1200:w-8/12 1366:w-8/12 1536:w-9/12  lg:max-w-6xl my-10 md:my-20">
              ...
              <div className={'flex flex-col md:flex-row mt-10 1728:mt-0 1200:mb-32 1280:-mb-40 1536:mb-10 1728:mb-32 1920:mb-32'}>
                  ...
                  <div className="shadow-xl md:flex-1 2240:flex-2 right-0 1200:translate-x-10 z-10 bg-gradient-to-bl from-blue-600 to-blue-700 rounded-xs ">
        ...
        <div className="relative 1200:-mt-64 1280:-mt-30 1366:-mt-30 1728:-mt-56 2240:-mt-26 2560:-mt-36 mx-auto max-w-8/12 2240:max-w-7/12 ">
          ...
          <div className="relative mt-24  max-w-4xl 1024:max-w-full md:w-11/12 1280:w-10/12 mx-auto -translate-y-20">
              <div className="flex flex-col 1200:flex-row gap-6 items-start">
                  ...
                  <div className="order-1 ml-10 1200:ml-0 w-full 1200:w-5/12 flex flex-col gap-6 relative z-10 1200:-translate-y-32">
                      {/* Div naranja */}
                      <div className="w-9/12 max-w-sm bg-gradient-to-tl p-16 from-blue-600 to-blue-700 p-10 rounded-xs">
                          <div className="flex flex-col gap-6">
                              <Titulo
                                  as="h2"
                  ...
                  <div className="order-2 w-full 1200:w-10/12 1728:w-11/12 1920:w-full 1200:-ml-56 1920:-ml-64 mt-10 relative z-0">
                      <div className="relative aspect-square md:aspect-16/9 1200:aspect-16/12 1366:aspect-16/10 1440:aspect-16/9 1536:aspect-16/8 overflow-visible rounded-xs">
                          ...
                          <motion.div
                            className="absolute top-0 left-1/2 -translate-x-1/2 translate-y-[40px] h-8 md:h-14 bg-gradient-to-tl from-blue-600 to-blue-700 z-10 -rotate-12"
                            initial={{ width: 0 }}
                          ...
                          >
                            {/* Círculo inicio */}
                            <motion.div
                              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 w-20 h-20 md:w-36 md:h-36 rounded-full bg-gradient-to-tl from-blue-600 to-blue-700 flex items-center justify-center"
                              initial={{ rotate: 0 }}
                            ...
                            {/* Círculo final */}
                            <motion.div
                              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-20 h-20 md:w-36 md:h-36 rounded-full bg-gradient-to-tl from-blue-600 to-blue-700 flex items-center justify-center"
                              initial={{ rotate: 0 }}
                              whileInView={{ rotate: 360 }}
                              transition={{ duration: 0.6, delay: 0.8, ease: "easeInOut" }}
                              viewport={{ once: true, margin: "0px" }}
          ...
          <div className="hidden md:block relative">
            ...
            <StickyRevealContent className="bg-gradient-to-br from-blue-600 to-blue-700">
              <HexagonFeatures />
            </StickyRevealContent>
          ...
          <section className="md:hidden bg-gradient-to-br from-blue-600 to-blue-700">
            <HexagonFeatures />
          </section>

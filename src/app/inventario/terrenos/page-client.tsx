    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-white dark:bg-zinc-900 shadow-xl overflow-y-auto">
        ...
        <div className="sticky top-0 z-10 bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800 px-6 py-4 flex items-center justify-between">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white">Terreno disponible</h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div className="bg-gray-50 dark:bg-zinc-800 rounded-xs p-4">
            <p className="text-xs font-medium uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-2">Superficie del terreno</p>
          ...
          {/* Ubicación legal */}
          <div>
            <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Ubicación legal</p>

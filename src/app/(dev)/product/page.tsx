...
import { ExpandableFeatures } from '@/app/(dev)/product/sections/expandable-features'
import { NotesFeatures } from '@/app/(dev)/product/sections/notes-features'
import HowItWorksSection from '@/app/(dev)/product/sections/how-it-works'
import { TestimonialSection } from '@/app/(dev)/product/sections/testimonial'
import { TestimonialsSection } from '@/app/(dev)/product/sections/testimonials-section'
